...
python esJson2csv -j ${tmpdir}/${topic}.json -o ${csvdir}/${topic}.csv -l "logtime,host,ip,app,TargetLogonId,TargetUsername" gethit -f "hit['_source']['logtime'],hit['_source']['bimap']['host'],hit['_source']['bimap']['ip'],hit['_source']['bimap']['app'],hit['_source']['event_data']['TargetLogonId'],hit['_source']['event_data']['TargetUserName']"
